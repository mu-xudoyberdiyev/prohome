      ...
      <section className="animate-fade-in h-full p-2">
        <div className="border relative px-3 py-6 rounded gap-5 select-none w-full">
          ...
          <div className="relative">
            ...
            {sales && (
              <>
                <div className="w-full rounded flex overflow-hidden mb-10">
                  <div className="p-2 bg-green-500 w-2/4">
                    <div className="flex items-center gap-1 mb-2">
                      <span className="text-primary-foreground text-xs">
                        Sotilgan uylar
                      </span>
                    </div>
                    <h4 className="text-lg font-mono font-medium text-primary-foreground">
                      {formatNumber(sales.totalSalesAmount)} UZS
                    </h4>
                  </div>
                  <div className="p-2 bg-red-800/50 w-2/4">
                    <div className="flex items-center gap-1 mb-2">
                      <span className="text-primary-foreground text-xs">
                        Qolgan uylar
                      </span>
